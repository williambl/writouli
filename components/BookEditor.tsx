...
export default function BookEditor(props: {book: Book, setBook: (book: Book) => void}) {
        ...
        return (
            <fieldset>
                    ...
                    <LabelledTextInput label="Book Texture:" isAdvanced={true} defaultValue={props.book.bookTexture} onChange={change => props.setBook(create(props.book, {bookTexture: change.target.value}))}/>
                    <LabelledTextInput label="Filler Texture:" isAdvanced={true} defaultValue={props.book.fillerTexture} onChange={change => props.setBook(create(props.book, {fillerTexture: change.target.value}))} />
                    <LabelledTextInput label="Crafting Texture:" isAdvanced={true} defaultValue={props.book.craftingTexture} onChange={change => props.setBook(create(props.book, {craftingTexture: change.target.value}))} />
                    <LabelledTextInput label="Model:" isAdvanced={true} defaultValue={props.book.model} onChange={change => props.setBook(create(props.book, {model: change.target.value}))} />
                    ...
                    <LabelledTextInput label="Creative Tab:" isAdvanced={true} defaultValue={props.book.creativeTab} onChange={change => props.setBook(create(props.book, {creativeTab: change.target.value}))} />
